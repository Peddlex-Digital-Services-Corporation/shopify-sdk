...
public class ShopifySdk {
	...
	public ShopifyCustomer createCustomer(final ShopifyCreateCustomerRequest request) {
		final ShopifyCreateCustomerRoot root = new ShopifyCreateCustomerRoot();
		root.setCustomer( request );
		final Response response = post(getWebTarget().path(CUSTOMERS + JSON), root);
	...
	public boolean deleteCustomer(String customerId) {
		final Response response = delete(getWebTarget().path(CUSTOMERS).path(customerId + JSON));
